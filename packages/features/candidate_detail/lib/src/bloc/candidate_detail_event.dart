...
sealed class CandidateDetailEvent with _$CandidateDetailEvent {
  ...
  const factory CandidateDetailEvent.pendingChanged(bool hasPending) = _PendingChanged;
  const factory CandidateDetailEvent.onlineChanged(bool isOnline) = _OnlineChanged;
